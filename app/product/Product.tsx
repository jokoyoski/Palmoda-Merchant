...
{product?.status !== "Approved" && product?.status !== "Rejected" && (
  ...
  <span className="font-semibold">Category:</span> {mapIdsToNames(product.categories, categoriesArray || [])}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-xs text-black flex gap-2"><span className="font-semibold">Stock:</span> {product.quantity} units</p>
            ...
            <div className="mt-6">
                ...
                <p className="text-xs text-gray-600 leading-relaxed mt-2">{product.description}</p>
              </div>
