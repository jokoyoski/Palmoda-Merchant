...
function page() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // ✅ fix #2: cast to File to satisfy URL.createObjectURL
    ...
    <section className='bg-gray-100 min-h-screen px-4  md:px-8 py-6 w-full'>
        ...
        <div className="flex flex-col gap-1.5 mb-4">
         ...
         <div className="flex flex-col gap-1.5">
              <label className="text-black font-semibold text-xs">Gender *</label>
              <div className="flex items-center gap-3 mt-1">
                {["Male", "Female", "Unisex"].map((g) => (
                  <label key={g} className="flex items-center gap-1 text-xs text-gray-600">
                    <input
                      type="radio"
                      name="gender"
                      value={g}
...
<div className='grid grid-cols-1 md:grid-cols-2 mt-5 gap-4'>
             ...
             <input type="text" name="" id="" placeholder='Cotton, Polyster, Silk etc.' className='
             text-gray-500 p-1 text-sm border border-gray-300 focus:ring-0' />
          </div>
          <div className='flex flex-col gap-1.5 w-full'>
             <label htmlFor="care" className='text-black font-semibold text-xs'>Care Instructions</label>
             <input type="text" name="" id="" placeholder='Machine wash cold, Dry clean only' className='
             text-gray-500 p-1 text-sm border border-gray-300 focus:ring-0' />
          </div>
            </div>
       ...
       <div className='mt-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 mt-3 gap-4'>
           <div className='flex flex-col gap-1.5 w-full'>
             ...
             <input type="number" name="" id="" defaultValue={0} className='
             text-gray-500 p-1 text-sm border border-gray-300 focus:ring-0' />
          </div>
           <div className='flex flex-col gap-1.5 w-full'>
